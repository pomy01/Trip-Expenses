/**
 * Javascript file to handle the facebook login.
 */

window.fbAsyncInit = function() {
	FB.init({
		appId : '450699658409076',
	...
	// Here we subscribe to the auth.authResponseChange JavaScript event. This
	// event is fired
	// for any authentication related change, such as login, logout or session
	// refresh. This means that
	// whenever someone who was previously logged out tries to log in again, the
	// correct case below
	// will be handled.
